<div class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?php echo e(action('Users\Groups\TeacherController@attach',[$groupObj->code])); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php echo e(trans('users.teachers.add')); ?></h4>
                </div>
                <div class="modal-body">
                    <p class="text-center"><?php echo trans('users.groups.add-teachers', ['group' => $groupObj->name] ); ?></p>
                    <div class="form-group">
                        <label for=""><?php echo e(trans('users.teachers.link')); ?></label>
                    ...
                    <div class="text-center">
                        <a class="btn btn-sm btn-danger" href="<?php echo e(action('Users\Groups\TeacherController@create', [$groupObj->code])); ?>">
                            <?php echo e(trans('users.teachers.create')); ?>
