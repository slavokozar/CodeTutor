<?php $__env->startSection('content-main'); ?>
    ...
    <form class="form-horizontal"
          action="<?php echo e($groupObj->id == null ? action('Users\Groups\GroupController@store') : action('Users\Groups\GroupController@update', $groupObj->code)); ?>"
          method="post">
        <?php echo csrf_field(); ?>
        ...
        <?php echo ContentNav::submit(['label' => $groupObj->id ? trans('general.save') : trans('general.create')]); ?>
