<?php $__env->startSection('content'); ?>
    ...
    <form class="form-horizontal" action="<?php echo e($schoolObj->id == null ? action('Users\Schools\SchoolController@store') : action('Users\Schools\SchoolController@update', $schoolObj->code)); ?>" method="post">
        <?php echo csrf_field(); ?>
        ...
        <main role="main">
            <section id="basic">
                ...
                <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-40">
                        <input class="form-control" type="text" name="name" value="<?php echo e(old('name', $schoolObj->name)); ?>"/>
                ...
                <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-40">
                        <textarea class="form-control" name="address"><?php echo e(old('address', $schoolObj->address)); ?></textarea>
