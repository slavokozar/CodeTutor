<div class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?php echo e(action('Users\Groups\TeacherController@store',[$groupObj->code])); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger"><?php echo e(trans('general.buttons.add')); ?></button>
                </div>
            </form>
        </div>
    </div>
