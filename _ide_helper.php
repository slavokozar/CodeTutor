...
namespace {
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
        ...
        /**
         * Get the profile resolver callback.
         *
         * @return \Closure 
         * @static 
         */
        ...
        /**
         * Create the profile provider implementation for the driver.
         *
         * @param string $provider
        ...
        /**
         * Get the ID for the currently authenticated profile.
         *
         * @return int|null 
         * @static 
         */
        ...
        /**
         * Log a profile into the application without sessions or cookies.
         *
        ...
        /**
         * Validate a profile's credentials.
         *
         * @param array $credentials
         * @return bool 
         * @static 
        ...
        /**
         * Attempt to authenticate a profile using the given credentials.
         *
         * @param array $credentials
         * @param bool $remember
         * @param bool $login
        ...
        /**
         * Log a profile into the application.
         *
        ...
        /**
         * Log the given profile ID into the application.
         *
         * @param mixed $id
         * @param bool $remember
        ...
        /**
         * Log the given profile ID into the application without sessions or cookies.
         *
         * @param mixed $id
         * @return \App\Models\User|false 
         * @static 
        ...
        /**
         * Log the profile out of the application.
         *
         * @return void 
         * @static 
         */
        ...
        /**
         * Get the profile provider used by the guard.
         *
         * @return \Illuminate\Contracts\Auth\UserProvider 
         * @static 
         */
        ...
        /**
         * Set the profile provider used by the guard.
         *
        ...
        /**
         * Return the currently cached profile.
         *
         * @return \App\Models\User|null 
         * @static 
         */
        ...
        /**
         * Get the last profile we attempted to authenticate.
         *
        ...
        /**
         * Determine if the profile was authenticated via "remember me" cookie.
         *
         * @return bool 
         * @static 
         */
        ...
        /**
         * Determine if the current profile is authenticated.
         *
         * @return \App\Models\User 
        ...
        /**
         * Determine if the current profile is a guest.
         *
         * @return bool 
         * @static 
         */
    ...
    class Gate extends \Illuminate\Support\Facades\Gate{
        ...
        /**
         * Determine if the given ability should be granted for the current profile.
         *
         * @param string $ability
        ...
        /**
         * Determine if the given ability should be denied for the current profile.
         *
         * @param string $ability
         * @param array|mixed $arguments
         * @return bool 
        ...
        /**
         * Get a gate instance for the given profile.
         *
    ...
    class Request extends \Illuminate\Support\Facades\Request{
        ...
        /**
         * Get the profile making the request.
         *
        ...
        /**
         * Set the profile resolver callback.
         *
         * @param \Closure $callback
         * @return $this 
         * @static 
         ...
         *
         * @return string A profile name and, optionally, scheme-specific information about how to gain authorization to access the server
         * @static 
         */
         ...
         * 
         * If the URL was called with basic authentication, the profile
         ...
         * 
         *  * format defined by the profile (with setRequestFormat())
         ...
         *
         * @return array Languages ordered in the profile browser preferences
         * @static 
         */
    ...
    class UploadService extends \App\Facades\UploadServiceFacade{
        
        /**
         * 
         *
         * @param \App\_Classes\Assignment $assignment
         * @param \App\_Classes\User $user
         * @param \App\_Classes\UploadedFile $upload
         * @return int number of stored bytes
         * @static 
         */
        public static function storeUpload($assignment, $user, $upload){
            return \App\_Classes\UploadService::storeUpload($assignment, $user, $upload);
        }
         ...
         * @static 
         */
        public static function moveToArchive($assignment, $user){
            return \App\_Classes\UploadService::moveToArchive($assignment, $user);
        }
        
    }


    class RequestService extends \App\Facades\RequestServiceFacade{
         ...
         * @static 
         */
        public static function sendAsyncRequest($type, $url, $content){
            return \App\_Classes\RequestService::sendAsyncRequest($type, $url, $content);
        }
         ...
         * @static 
         */
        public static function sendRequest($type, $url, $content){
            return \App\_Classes\RequestService::sendRequest($type, $url, $content);
        }
