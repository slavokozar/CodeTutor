<div class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ action('Assignments\AssignmentController@destroy', $assignmentObj->code) }}" method="post">
                {!! csrf_field() !!}
                ...
                <div class="modal-body">
                    ...
                    <p class="text-center text-danger">{!! trans('assignments.delete.message', ['name' => $assignmentObj->name] ) !!}</p>
                </div>
