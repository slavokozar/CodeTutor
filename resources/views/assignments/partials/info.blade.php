@inject('assignmentService', 'App\Services\Assignments\AssignmentService')

<div id="assignment-info">
<span class="assignment-deadline">zostáva {!! $assignmentService->deadline($assignmentObj) !!}</span>
    @if(Auth::check())
        {{--<br/>--}}
