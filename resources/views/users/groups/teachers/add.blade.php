<div class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ action('Users\Groups\TeacherController@attach',[$groupObj->code]) }}" method="post">
                {!! csrf_field() !!}
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <a class="btn btn-sm btn-danger" href="{{ action('Users\Groups\TeacherController@create', [$groupObj->code]) }}">
                            {{ trans('users.teachers.create') }}
                        </a>
                    </div>
